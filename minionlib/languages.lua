...
function SetLanguage(event, arg)
	...
	if ( tonumber(arg) ~= nil ) then
		...
		elseif ( arg == "4" ) then gCurrentLanguage = "sp" 
		elseif ( arg == "5" ) then gCurrentLanguage = "fr"
        elseif ( arg == "6" ) then gCurrentLanguage = "ru"
        elseif ( arg == "7" ) then gCurrentLanguage = "pl"
        elseif ( arg == "8" ) then gCurrentLanguage = "tr" 
		end
	end	
end
