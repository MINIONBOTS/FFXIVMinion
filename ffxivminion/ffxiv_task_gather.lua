...
ffxiv_task_gather.editwindow = {name = "Location Editor", x = 0, y = 0, width = 250, height = 230}
...
function ffxiv_task_gather.UIInit()
	...
	GUI_NewField(winName,"Location Name","gGatherMapLocation",group)
	
	group = GetString("settings")
	GUI_NewCheckbox(winName,"Gather Unspoiled", "gGatherUnspoiled",group)
	GUI_NewCheckbox(winName,"Use Cordials", "gGatherUseCordials",group)
	GUI_NewComboBox(winName,"Start Location","gGatherStartLocation",group,"")
	...
	GUI_NewField(winName,"Miner Gearset","gGatherMinerGearset",group )
	GUI_NewField(winName,"Botanist Gearset","gGatherBotanistGearset",group )
	--GUI_NewField(winName,strings[gCurrentLanguage].throttle,"gGatherThrottle",group)
	
	group = GetString("newLocation")
	GUI_NewField(winName,"Location Name",		"gGatherMapName",group)
	GUI_NewButton(winName,"Refresh Map",		"ffxiv_gatherRefreshMap",group)
	GUI_NewNumeric(winName,"Map Hour",			"gGatherMapHour",group, "0", "23")
	GUI_NewComboBox(winName,"Class",			"gGatherMapClass",group, "MINER,BOTANIST")	
	GUI_NewComboBox(winName,"Marker",			"gGatherMapMarker",group,"")
	gGatherMapMarker_listitems = ffxiv_task_gather.GetUnspoiledMarkers()
	GUI_NewCheckbox(winName,"Is Idle", 			"gGatherMapIdle",group)
	GUI_NewButton(winName,"Add Location",		"ffxiv_gatherAddLocation",group)
	...
	group = GetString("settings")
	GUI_NewField(winName,"Location Name",		"eGatherMapName",group)
	GUI_NewCheckbox(winName,"Enabled", 			"eGatherMapEnabled",group)
	GUI_NewButton(winName,"Refresh Map",		"ffxiv_gatherRefreshMap",group)
	GUI_NewNumeric(winName,"Map Hour",			"eGatherMapHour",group, "0", "23")
	GUI_NewComboBox(winName,"Class",			"eGatherMapClass",group, "MINER,BOTANIST")
	GUI_NewComboBox(winName,"Marker",			"eGatherMapMarker",group,"")
	gGatherMapMarker_listitems = ffxiv_task_gather.GetUnspoiledMarkers()
	GUI_NewCheckbox(winName,"Is Idle", 			"eGatherMapIdle",group)
	GUI_NewButton(winName,"Save Location",		"ffxiv_gatherSaveLocation")
	GUI_NewButton(winName,"Remove Location",	"ffxiv_gatherRemoveLocation")
	GUI_UnFoldGroup(winName,GetString("settings"))
