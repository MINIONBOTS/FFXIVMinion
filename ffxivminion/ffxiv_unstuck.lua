...
function c_stuck:evaluate()
	...
	if (MIsLocked() or IsFlying() or (MIsGCDLocked() and not Player.ismounted and not IsTransporting()) or MIsLoading() or Player:GetNavStatus() ~= 1 or HasBuffs(Player, "13")) then
