...
if (not FileExists(ffxiv_combat_samurai.optionsPath)) then
	...
	persistence.store(ffxiv_combat_samurai.optionsPath,defaults)
end
local options, e = persistence.load(ffxiv_combat_samurai.optionsPath)
if (options) then
	ffxiv_combat_samurai.options = options
end
