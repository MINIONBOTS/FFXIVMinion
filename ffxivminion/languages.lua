...
{	
    ...
    ["en"] =
    {
		...
		betaDebug						= "Beta Debug",
		betaDebugDescription			= "Enable diagnostic logs for beta features.",
		betaDebugNavigation				= "Navigation & Landing",
		betaDebugOMC					= "OMC Jump Diagnostics",
		betaDebugDive					= "Dive & Interaction Diagnostics",
		betaDebugTaskHandoff				= "Task Handoff Diagnostics",
		betaDebugArgus					= "Avoidance Diagnostics",
