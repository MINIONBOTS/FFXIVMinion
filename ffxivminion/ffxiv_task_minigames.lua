...
function ffxiv_task_minigames:Draw()
	...
	if (tabs.tabs[1].isselected) then
		...
		GUI:Columns(2)
		GUI:AlignFirstTextHeightToWidgets() GUI:Text(GetString("CuffaCur"))
		if (GUI:IsItemHovered()) then GUI:SetTooltip(GetString("CuffaCurTooltip")) end
		GUI:AlignFirstTextHeightToWidgets() GUI:Text(GetString("MonsterToss"))
		if (GUI:IsItemHovered()) then GUI:SetTooltip(GetString("CuffaCurTooltip")) end
		GUI:AlignFirstTextHeightToWidgets() GUI:Text(GetString("TowerStriker"))
		if (GUI:IsItemHovered()) then GUI:SetTooltip(GetString("CuffaCurTooltip")) end
		GUI:NextColumn()
		GUI_Capture(GUI:Checkbox("##CuffaCur",gMGOptionPunch),"gMGOptionPunch", 
			function ()
		...
		if (GUI:IsItemHovered()) then GUI:SetTooltip(GetString("CuffaCurTooltip")) end
		GUI_Capture(GUI:Checkbox("##MonsterToss",gMGOptionToss),"gMGOptionToss", 
			function ()
		...
		if (GUI:IsItemHovered()) then GUI:SetTooltip(GetString("CuffaCurTooltip")) end
		GUI_Capture(GUI:Checkbox("##TowerStriker",gMGOptionHammer),"gMGOptionHammer", 
			function ()
				GUI_Set("gMGOptionPunch",false)
				GUI_Set("gMGOptionToss",false)
			end
	...
	if (tabs.tabs[2].isselected) then
		...
		GUI:Columns(2)
		GUI:AlignFirstTextHeightToWidgets() GUI:Text(GetString("RandomizeGame"))
		if (GUI:IsItemHovered()) then GUI:SetTooltip(GetString("RandomizeGameTooltip")) end
		GUI:AlignFirstTextHeightToWidgets() GUI:Text(GetString("RandomTimeMin"))
		if (GUI:IsItemHovered()) then GUI:SetTooltip(GetString("RandomTimeMinTooltip")) end
		GUI:AlignFirstTextHeightToWidgets() GUI:Text(GetString("RandomTimeMax"))
		if (GUI:IsItemHovered()) then GUI:SetTooltip(GetString("RandomTimeMaxTooltip")) end
		GUI:AlignFirstTextHeightToWidgets() GUI:Text(GetString("PlayTime"))
		if (GUI:IsItemHovered()) then GUI:SetTooltip(GetString("PlayTimeTooltip")) end
		GUI:AlignFirstTextHeightToWidgets() GUI:Text(GetString("RestTime"))
		if (GUI:IsItemHovered()) then GUI:SetTooltip(GetString("RestTimeTooltip")) end
		GUI:AlignFirstTextHeightToWidgets() GUI:Text(GetString("PostGameDelay"))
		...
		GUI_Capture(GUI:Checkbox("##RandomizeGame",gMGRandomize),"gMGRandomize");
		if (GUI:IsItemHovered()) then GUI:SetTooltip(GetString("RandomizeGameTooltip")) end
		GUI_DrawIntMinMax("##RandomTimeMin","gMGRandomizeTimeMin",1,5,0,120)
		if (GUI:IsItemHovered()) then GUI:SetTooltip(GetString("RandomTimeMinTooltip")) end
		GUI_DrawIntMinMax("##RandomTimeMax","gMGRandomizeTimeMax",1,5,0,120)
		if (GUI:IsItemHovered()) then GUI:SetTooltip(GetString("RandomTimeMaxTooltip")) end
		GUI_DrawIntMinMax("##PlayTime","gMGPlayTime",1,5,0,360)
		if (GUI:IsItemHovered()) then GUI:SetTooltip(GetString("PlayTimeTooltip")) end
