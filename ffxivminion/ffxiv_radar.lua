...
function ffxiv_radar.SetData()
	ffxiv_radar.HuntFilters = {
		["ARR"] = {
			["S"] = {
				[2953] = true, -- Laideronnette
				[2954] = true, -- Wulgaru
				[2955] = true, -- Mindflayer
				[2956] = true, -- Thousand-cast Theda
				[2957] = true, -- Zona Seeker
				[2958] = true, -- Brontes
				[2959] = true, -- Lampalagua
				[2960] = true, -- Nunyunuwi
				[2961] = true, -- Minhocao
				[2962] = true, -- Croque-mitaine
				[2963] = true, -- Croakadile
				[2964] = true, -- The Garlok
				[2965] = true, -- Bonnacon
				[2966] = true, -- Nandi
				[2967] = true, -- Chernobog
				[2968] = true, -- Safat
				[2969] = true, -- Agrippa the Mighty
			},
			["A"] = {
				[2936] = true, -- Forneus
				[2937] = true, -- Melt
				[2938] = true, -- Ghede Ti Malice
				[2939] = true, -- Girtab
				[2940] = true, -- Alectryon
				[2941] = true, -- Sabotender Bailarina
				[2942] = true, -- Maahes
				[2943] = true, -- Zanig'oh
				[2944] = true, -- Dalvag's Final Flame
				[2945] = true, -- Vogaal Ja
				[2946] = true, -- Unktehi
				[2947] = true, -- Hellsclaw
				[2948] = true, -- Nahn
			...
			["B"] = {
				[2919] = true, -- White Joker
				[2920] = true, -- Stinging Sophie
				[2921] = true, -- Monarch Ogrefly
				[2922] = true, -- Phecda
				[2923] = true, -- Sewer Syrup
				[2924] = true, -- Ovjang
				[2925] = true, -- Gatling
				[2926] = true, -- Albin the Ashen
				[2927] = true, -- Flame Sergeant Dalvag
				[2928] = true, -- Skogs Fru
				[2929] = true, -- Barbastelle
				[2930] = true, -- Bloody Mary
				[2931] = true, -- Dark Helmet
				[2932] = true, -- Myradrosh
				[2933] = true, -- Vuokho
				[2934] = true, -- Naul
				[2935] = true, -- Leech King
			},
		},
		["HW"] = {
			["S"] = {
				[4374] = true, -- Kaiser Behemoth
				[4375] = true, -- Senmurv
				[4376] = true, -- The Pale Rider
				[4377] = true, -- Gandarewa
				[4378] = true, -- Bird of Paradise
				[4380] = true, -- Leucrotta
			},
			["A"] = {
				[4362] = true, -- Mirka
				[4363] = true, -- Lyuba
				[4364] = true, -- Pylraster
				[4365] = true, -- Lord of the Wyverns
				[4366] = true, -- Slipkinx Steeljoints
				[4367] = true, -- Stolas
				[4368] = true, -- Bune
				[4369] = true, -- Agathos
				[4370] = true, -- Enkelados
				[4371] = true, -- Sisiutl
				[4372] = true, -- Campacti
				[4373] = true, -- Stench Blossom
			},
			["B"] = {
				[4350] = true, -- Alteci
				[4351] = true, -- Kreutzet
				[4352] = true, -- Gnath Cometdrone
				[4353] = true, -- Thextera
				[4354] = true, -- Pterygotus
				[4355] = true, -- False Gigantopithecus
				[4356] = true, -- Scitalis
				[4357] = true, -- The Scarecrow
				[4358] = true, -- Squonk
				[4359] = true, -- Sanu Vali of Dancing Wings
				[4360] = true, -- Lycidas
				[4361] = true, -- Omni
			},
		},
		["StB"] = {
			["S"] = {
				...
				[5986] = true, -- Orghana
				[5987] = true, -- Udumbara
				[5988] = true, -- Bone Crawler
				[5989] = true, -- Salt and Light
			},
			["A"] = {
				[5990] = true, -- Orcus
				[5991] = true, -- Erle
				[5992] = true, -- Vochstein
				[5993] = true, -- Aqrabuamelu
				[5994] = true, -- Mahisha
				[5995] = true, -- Luminare
				[5996] = true, -- Funa Yurei
				[5997] = true, -- Oni Yumemi
				[5998] = true, -- Gajasura
				[5999] = true, -- Angada
				[6000] = true, -- Girimekhala
				[6001] = true, -- Sum
			},
			["B"] = {
				[6002] = true, -- Gauki Strongblade
				[6003] = true, -- Guhuo Niao
				[6004] = true, -- Deidar
				[6005] = true, -- Gyorai Quickstrike
				[6006] = true, -- Kurma
				[6007] = true, -- Aswang
				[6008] = true, -- Shadow-dweller Yamini
				[6009] = true, -- Ouzelum
				[6010] = true, -- Gwas-y-neidr
				[6011] = true, -- Buccaboo
				[6012] = true, -- Manes
				[6013] = true, -- Kiwa
			},
		...
		["ShB"] = {
			["SS"] = {
				[8915] = true, -- Forgiven Rebellion
				[8916] = true, -- Forgiven Gossip
			},
			["S"] = {
				[8653] = true, -- Aglaope
				[8890] = true, -- Ixtab
				...
				[8900] = true, -- Tarchia
				[8905] = true, -- Tyger
				[8910] = true, -- Forgiven Pedantry
			},
			["A"] = {
				[8654] = true, -- The Mudman
				[8655] = true, -- O Poorest Pauldia
				[8891] = true, -- Supay
				[8892] = true, -- Grassman
				[8896] = true, -- Rusalka
				[8897] = true, -- Baal
				[8901] = true, -- Maliktender
				[8902] = true, -- Sugaar
				[8906] = true, -- Nuckelavee
				[8907] = true, -- Nariphon
				[8911] = true, -- Li'l Murderer
				[8912] = true, -- Huracan
			},
			["B"] = {
				[8656] = true, -- Domovoi
				...
				[8893] = true, -- Mindmaker
				[8894] = true, -- Pachamama
				[8898] = true, -- Gilshs Aath Swiftclaw
				[8899] = true, -- Deacon
				[8903] = true, -- Worm of the Well
				[8904] = true, -- Juggler Hecatomb
				[8908] = true, -- La Velue
				[8909] = true, -- Itzpapalotl
				[8913] = true, -- Coquecigrue
				[8914] = true, -- Indomitable
			},
		},
		["EW"] = {
			["SS"] = {
				[10615] = true, -- Ker
				[10616] = true, -- Ker Shroud
			},
			["S"] = {	
				[10617] = true, -- Burfurlur the Canny
				[10618] = true, -- Sphatika
				[10619] = true, -- Armstrong
				[10620] = true, -- Ruminator
				[10621] = true, -- Ophioneus
				[10622] = true, -- Narrow-Rift
			},
			["A"] = {
				[10623] = true, -- Storsie
				[10624] = true, -- Hulder
				...
				[10627] = true, -- Minerva
				[10628] = true, -- Aegeiros
				[10629] = true, -- Lunatender Queen
				[10630] = true, -- Mousse Princess
				[10631] = true, -- Gurangatch
				[10632] = true, -- Petalodus
				[10633] = true, -- Fan Ail
				[10634] = true, -- Arch-Eta	
			},
			["B"] = {
				[10635] = true, -- Green Archon
				[10636] = true, -- Ü-u-ü-u
				[10637] = true, -- Iravati
				[10638] = true, -- Vajrakumara
				[10639] = true, -- Warmonger
				[10640] = true, -- Emperor's Rose
				[10641] = true, -- Daphnia Magna
				[10642] = true, -- Genesis Rock
				[10643] = true, -- Yumcax
				[10644] = true, -- Shockmaw
				[10645] = true, -- Level Cheater
				[10646] = true, -- Oskh Rhei
			},
		}
	}
