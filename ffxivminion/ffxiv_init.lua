...
function ml_global_information.Init()
	...
	do
		...
		ml_mesh_mgr.SetDefaultMesh(237, "Central Shroud")
		ml_mesh_mgr.SetDefaultMesh(238, "Old Gridania")
		ml_mesh_mgr.SetDefaultMesh(239, "Central Shroud")
		ml_mesh_mgr.SetDefaultMesh(240, "North Shroud")
		ml_mesh_mgr.SetDefaultMesh(251, "Ul dah - Steps of Nald")
		ml_mesh_mgr.SetDefaultMesh(253, "Central Thanalan")
		...
		ml_mesh_mgr.SetDefaultMesh(328, "Upper La Noscea")
		ml_mesh_mgr.SetDefaultMesh(329, "Map 329")
		...
		ml_mesh_mgr.SetDefaultMesh(407, "Lower La Noscea")
		...
		ml_mesh_mgr.SetDefaultMesh(413, "Western La Noscea")
		...
		ml_mesh_mgr.SetDefaultMesh(466, "Upper La Noscea")
		...
		ml_mesh_mgr.SetDefaultMesh(484, "Lower La Noscea")
		...
		ml_mesh_mgr.SetDefaultMesh(494, "Eastern Thanalan")	
