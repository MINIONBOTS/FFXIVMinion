...
function ml_global_information.Init()
	...
	do
		...
		ml_mesh_mgr.SetDefaultMesh(155, "Coerthas Central Highlands")
		ml_mesh_mgr.SetDefaultMesh(156, "Mor Dhona")
		ml_mesh_mgr.SetDefaultMesh(180, "Outer La Noscea")
		ml_mesh_mgr.SetDefaultMesh(337, "Wolves' Den Pier")
		ml_mesh_mgr.SetDefaultMesh(336, "Wolves' Den Pier")
		ml_mesh_mgr.SetDefaultMesh(175, "Wolves' Den Pier")
		ml_mesh_mgr.SetDefaultMesh(352, "Wolves' Den Pier")
		ml_mesh_mgr.SetDefaultMesh(186, "Wolves' Den Pier")
		...
		ml_mesh_mgr.SetDefaultMesh(128, "Limsa Lominsa Upper Decks")
		ml_mesh_mgr.SetDefaultMesh(181, "Limsa Lominsa")
		ml_mesh_mgr.SetDefaultMesh(129, "Limsa Lominsa Lower Decks")
		...
		ml_mesh_mgr.SetDefaultMesh(179, "The Roost")
		ml_mesh_mgr.SetDefaultMesh(178, "The Hourglass")
		ml_mesh_mgr.SetDefaultMesh(177, "Mizzenmast Inn")
		
		ml_mesh_mgr.SetDefaultMesh(210, "Heart of the Sworn")
		ml_mesh_mgr.SetDefaultMesh(205, "Lotus Stand")
		ml_mesh_mgr.SetDefaultMesh(198, "Command Room")
		ml_mesh_mgr.SetDefaultMesh(204, "Seat of the First Bow")
		
		ml_mesh_mgr.SetDefaultMesh(144, "Gold Saucer")
		ml_mesh_mgr.SetDefaultMesh(388, "Gold Saucer - Chocobo Square")
		
		ml_mesh_mgr.SetDefaultMesh(331, "The Howling Eye")
		...
		ml_mesh_mgr.SetDefaultMesh(418, "Foundation")
		ml_mesh_mgr.SetDefaultMesh(419, "The Pillars")
		ml_mesh_mgr.SetDefaultMesh(427, "Saint Endalim's Scholasticate")
		ml_mesh_mgr.SetDefaultMesh(428, "Seat of the Lord Commander")
		ml_mesh_mgr.SetDefaultMesh(439, "The Lightfeather Proving Grounds")
		ml_mesh_mgr.SetDefaultMesh(433, "Fortemps Manor")
		ml_mesh_mgr.SetDefaultMesh(456, "Ruling Chamber")
		...
		ml_mesh_mgr.SetDefaultMesh(635, "Rhalgr's Reach")	
		ml_mesh_mgr.SetDefaultMesh(639, "Ruby Bazaar Offices")		
		ml_mesh_mgr.SetDefaultMesh(680, "ImOnABoat")
		...
		ml_mesh_mgr.SetDefaultMesh(786, "Castrum Fluminis")
		
		
		-- Dungeons
		--ml_mesh_mgr.SetDefaultMesh(435, "[Dungeon]Aery")
		ml_mesh_mgr.SetDefaultMesh(167, "[Dungeon] Amdapor Keep")
		ml_mesh_mgr.SetDefaultMesh(172, "[Dungeon] Aurum Vale")
		ml_mesh_mgr.SetDefaultMesh(158, "[Dungeon] Brayflox")
		ml_mesh_mgr.SetDefaultMesh(362, "[Dungeon] Brayflox (Hard)")
		ml_mesh_mgr.SetDefaultMesh(161, "[Dungeon] Copperbell Mines")
		ml_mesh_mgr.SetDefaultMesh(349, "[Dungeon] Copperbell (Hard)")
		ml_mesh_mgr.SetDefaultMesh(170, "[Dungeon] Cutter's Cry")
		ml_mesh_mgr.SetDefaultMesh(434, "[Dungeon] Dusk Vigil")
		ml_mesh_mgr.SetDefaultMesh(171, "[Dungeon] Dzemael Darkhold")
		ml_mesh_mgr.SetDefaultMesh(162, "[Dungeon] Halatali")
		ml_mesh_mgr.SetDefaultMesh(360, "[Dungeon] Halatali (Hard)")
		ml_mesh_mgr.SetDefaultMesh(166, "[Dungeon] Haukke Manor")
		ml_mesh_mgr.SetDefaultMesh(350, "[Dungeon] Haukke Manor (Hard)")
		...
		ml_mesh_mgr.SetDefaultMesh(387, "[Dungeon] Sastasha (Hard)")
		--ml_mesh_mgr.SetDefaultMesh(371, "[Dungeon]Snowcloak")
		ml_mesh_mgr.SetDefaultMesh(441, "[Dungeon] Sohm Al")
		ml_mesh_mgr.SetDefaultMesh(168, "[Dungeon] Stone Vigil")
		...
		ml_mesh_mgr.SetDefaultMesh(169, "[Dungeon] Toto-Rak")
		ml_mesh_mgr.SetDefaultMesh(421, "[Dungeon] The Vault")
		ml_mesh_mgr.SetDefaultMesh(159, "[Dungeon] Wanderers Palace")
	...
	--	ml_mesh_mgr.SetDefaultMesh(426, "[Trial]Chrysalis")
		...
		ml_mesh_mgr.SetDefaultMesh(202, "[Trial] The Bowl of Embers")
		...
		ml_mesh_mgr.SetDefaultMesh(206, "[Trial] The Navel")		
		...
		ml_mesh_mgr.SetDefaultMesh(258, "Duty_558")
		ml_mesh_mgr.SetDefaultMesh(259, "Duty_562")
		ml_mesh_mgr.SetDefaultMesh(260, "Duty_566")
		...
		ml_mesh_mgr.SetDefaultMesh(270, "Duty_550")
		...
		ml_mesh_mgr.SetDefaultMesh(313, "Duty_1060")
		ml_mesh_mgr.SetDefaultMesh(314, "Central Thanalan")
		ml_mesh_mgr.SetDefaultMesh(315, "Mor Dhona")	
		ml_mesh_mgr.SetDefaultMesh(316, "Coerthas Central Highlands")
		...
		ml_mesh_mgr.SetDefaultMesh(322, "Coerthas Central Highlands")	
		ml_mesh_mgr.SetDefaultMesh(323, "Southern Thanalan")
		ml_mesh_mgr.SetDefaultMesh(324, "North Shroud")	
		ml_mesh_mgr.SetDefaultMesh(325, "Duty_1095")
		ml_mesh_mgr.SetDefaultMesh(326, "Duty_1096")	
		...
		ml_mesh_mgr.SetDefaultMesh(404, "Limsa Lominsa Lower Decks")
		...
		ml_mesh_mgr.SetDefaultMesh(414, "Duty_233")
		...
		ml_mesh_mgr.SetDefaultMesh(468, "Coerthas Central Highlands")	
		ml_mesh_mgr.SetDefaultMesh(469, "Coerthas Central Highlands")	
		...
		ml_mesh_mgr.SetDefaultMesh(474, "Limsa Lominsa Upper Decks")
		ml_mesh_mgr.SetDefaultMesh(475, "Coerthas Central Highlands")	
		...
		ml_mesh_mgr.SetDefaultMesh(487, "Coerthas Central Highlands")	
		ml_mesh_mgr.SetDefaultMesh(488, "Coerthas Central Highlands")	
		...
		ml_mesh_mgr.SetDefaultMesh(496, "Coerthas Central Highlands")	
		ml_mesh_mgr.SetDefaultMesh(497, "Coerthas Western Highlands")
		ml_mesh_mgr.SetDefaultMesh(498, "Coerthas Western Highlands")
		ml_mesh_mgr.SetDefaultMesh(499, "The Pillars")
		ml_mesh_mgr.SetDefaultMesh(500, "Duty_2058")
		ml_mesh_mgr.SetDefaultMesh(501, "Duty_2063")
		...
		ml_mesh_mgr.SetDefaultMesh(666, "Ul'dah - Steps of Thal")
		...
		ml_mesh_mgr.SetDefaultMesh(701, "Duty_2627")
		ml_mesh_mgr.SetDefaultMesh(702, "Duty_2629")
		ml_mesh_mgr.SetDefaultMesh(703, "Duty_2892")
		ml_mesh_mgr.SetDefaultMesh(704, "Duty_2894")
		ml_mesh_mgr.SetDefaultMesh(705, "Ul'dah - Steps of Thal")
		ml_mesh_mgr.SetDefaultMesh(706, "Ul'dah - Steps of Thal")
		...
		ml_mesh_mgr.SetDefaultMesh(707, "Duty_2587") -- rdm 70 #1
		]]
		
		-- Latty SB
		ml_mesh_mgr.SetDefaultMesh(249, "Duty_414")
		ml_mesh_mgr.SetDefaultMesh(271, "Duty_551")
		ml_mesh_mgr.SetDefaultMesh(457, "Akh Afah Amphitheatre")
		ml_mesh_mgr.SetDefaultMesh(459, "Duty_1667")
		ml_mesh_mgr.SetDefaultMesh(460, "Duty_1601")
		ml_mesh_mgr.SetDefaultMesh(461, "The Sea of Clouds")
		ml_mesh_mgr.SetDefaultMesh(462, "Sacrificial Chamber")
		ml_mesh_mgr.SetDefaultMesh(513, "Duty_2163")
		--ml_mesh_mgr.SetDefaultMesh(533, "Duty_2239")
		--ml_mesh_mgr.SetDefaultMesh(533, "Duty_2239_A")
		ml_mesh_mgr.SetDefaultMesh(592, "Bowl of Embers")
		ml_mesh_mgr.SetDefaultMesh(633, "Duty_2358")
		ml_mesh_mgr.SetDefaultMesh(636, "Map636")
		...
		ml_mesh_mgr.SetDefaultMesh(738, "Resonatorium")
