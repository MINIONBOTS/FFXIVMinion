...
function ml_global_information.Init()
	...
	do
		...
		-- Dungeons SB
		ml_mesh_mgr.SetDefaultMesh(1142, "[Dungeon] The Sirensong Sea", enforce)
		ml_mesh_mgr.SetDefaultMesh(616 "[Dungeon] Shisui of the Violet Tides", enforce)
		ml_mesh_mgr.SetDefaultMesh(623, "[Dungeon] Bardam's Mettle", enforce)
		ml_mesh_mgr.SetDefaultMesh(660, "[Dungeon] Doma Castle", enforce)
		ml_mesh_mgr.SetDefaultMesh(1145, "[Dungeon] Castrum Abania", enforce)
		ml_mesh_mgr.SetDefaultMesh(1146, "[Dungeon] Ala Mhigo", enforce)
		ml_mesh_mgr.SetDefaultMesh(662, "[Dungeon] Kugane Castle", enforce)
		ml_mesh_mgr.SetDefaultMesh(663, "[Dungeon] The Temple of the Fist", enforce)
		ml_mesh_mgr.SetDefaultMesh(731, "[Dungeon] The Drowned City of Skalla", enforce)
		ml_mesh_mgr.SetDefaultMesh(742, "[Dungeon] Hells' Lid", enforce)
