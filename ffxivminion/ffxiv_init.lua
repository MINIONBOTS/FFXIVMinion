...
function ml_global_information.Init()
	...
	do
		...
		--ml_mesh_mgr.SetDefaultMesh(???, "[Dungeon] The Great Gubal Library", enforce)
		...
		ml_mesh_mgr.SetDefaultMesh(331, "The Howling Eye", true)
		...
		--ml_mesh_mgr.SetDefaultMesh(???, "[Trial] Hells' KierEX", enforce)
		...
		ml_mesh_mgr.SetDefaultMesh(878, "Duty_3254", true)
