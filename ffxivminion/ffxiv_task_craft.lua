...
function ffxiv_task_craft.UIInit()
	...
	group = "Collectible"
	local collectStringCraft1 = AceLib.API.Items.BuildRecipeString(FF.JOBS.CARPENTER,0,51)
	local collectStringCraft2 = AceLib.API.Items.BuildRecipeString(FF.JOBS.BLACKSMITH,0,51)
	local collectStringCraft3 = AceLib.API.Items.BuildRecipeString(FF.JOBS.ARMORER,0,51)
	local collectStringCraft4 = AceLib.API.Items.BuildRecipeString(FF.JOBS.GOLDSMITH,0,51)
	local collectStringCraft5 = AceLib.API.Items.BuildRecipeString(FF.JOBS.LEATHERWORKER,0,51)
	local collectStringCraft6 = AceLib.API.Items.BuildRecipeString(FF.JOBS.WEAVER,0,51)
	local collectStringCraft7 = AceLib.API.Items.BuildRecipeString(FF.JOBS.ALCHEMIST,0,51)
	local collectStringCraft8 = AceLib.API.Items.BuildRecipeString(FF.JOBS.CULINARIAN,0,51)
