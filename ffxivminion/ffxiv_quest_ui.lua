...
QM.Strings = {
	...
	QuestJobs = "None,ARCANIST,ARCHER,BARD,BLACKMAGE,CONJURER,DRAGOON,GLADIATOR,LANCER,MARAUDER,MONK,NINJA,PALADIN,PUGILIST,ROGUE,SCHOLAR,SUMMONER,THAUMATURGE,WARRIOR,WHITEMAGE",
	PreReqJobs = "All,ARCANIST,ARCHER,BARD,BLACKMAGE,CONJURER,DRAGOON,GLADIATOR,LANCER,MARAUDER,MONK,NINJA,PALADIN,PUGILIST,ROGUE,SCHOLAR,SUMMONER,THAUMATURGE,WARRIOR,WHITEMAGE",
}
