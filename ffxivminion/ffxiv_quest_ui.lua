...
QM.Windows = {
	Main = {visible = false, name = GetString("profileManager"), visibleDefault = false, onOpen = "QM.LoadProfile",
		x = 500, y = 40, width = 250, height = 520
	},
	QuestEditor = {visible = false, name = GetString("questEditor"), visibleDefault = false,
		base = "Main", width = 250, height = 275
	},
	StepManager = {visible = false, name = GetString("questSteps"), visibleDefault = false, onOpen = "QM.LoadTaskFields",
		base = "QuestEditor", width = 250, height = 400
	},
	StepEditor = {visible = false, name = GetString("questStepEditor"), visibleDefault = false,
		base = "StepManager", width = 250, height = 400
	},
	ItemEditor = {visible = false, name = GetString("questItemEditor"), visibleDefault = false, onOpen = "QM.RefreshStepItems",
	...
	TurnInEditor = {visible = false, name = GetString("questTurnoverEditor"), visibleDefault = false, onOpen = "QM.PullTurnoverItem;QM.RefreshTurnovers",
		base = "StepManager", width = 250, height = 275
	},
	PreReqEditor = {visible = false, name = GetString("questPreReqEditor"), visibleDefault = false, onOpen = "QM.RefreshPreReqs",
...
QM.Builds = {
	Main = {
		{5, "GUI_NewComboBox",QM.Windows.Main.name,GetString("profileType"),		"qProfileType",	GetString("details"), GetString("dutyMode")..","..GetString("questMode")},
		{5, "GUI_NewComboBox",QM.Windows.Main.name,GetString("existingProfile"), "qProfileName",	GetString("details"), "None"},
		{4, "GUI_NewField", 	QM.Windows.Main.name,GetString("newProfileName"),	"qProfileNew",	GetString("details")},
		{4, "GUI_NewButton", 	QM.Windows.Main.name,GetString("createProfile"), 	"QM.CreateProfile", GetString("details")},
		{3, "GUI_NewButton", 	QM.Windows.Main.name,GetString("saveProfile"), 	"QM.SaveProfile"},
	},
	LoadTypeOptions = {
	...
	Quest = {
		{4, "GUI_NewField",		QM.Windows.Main.name,GetString("questID"),			"qQuestID",		GetString("newQuest")},
		{4, "GUI_NewField",		QM.Windows.Main.name,"Quest Name",			"qQuestName",		GetString("newQuest")},
		{4, "GUI_NewButton",	QM.Windows.Main.name,GetString("questPullID"), 	"QM.PullQuest",	GetString("newQuest")},
		{5, "GUI_NewComboBox",	QM.Windows.Main.name,GetString("questJob"),		"qQuestJob",	GetString("newQuest"), QM.Strings.QuestJobs},
		{4, "GUI_NewField",		QM.Windows.Main.name,GetString("questLevel"),		"qQuestLevel",	GetString("newQuest")},
		{4, "GUI_NewButton",	QM.Windows.Main.name,GetString("questAddQuest"), 	"QM.AddQuest",  GetString("newQuest")},
	},
	QuestEditor = {
		{4, "GUI_NewField",		QM.Windows.QuestEditor.name,GetString("questID"),		"eQuestID",		 GetString("details")},
		{4, "GUI_NewField",		QM.Windows.QuestEditor.name,"Quest Name",		"eQuestName",	 GetString("details")},
		{4, "GUI_NewButton",	QM.Windows.QuestEditor.name,GetString("questPullID"), 	"QM.PullQuest",	 GetString("details")},
		{5, "GUI_NewComboBox",	QM.Windows.QuestEditor.name,GetString("questJob"),		"eQuestJob",	 GetString("details"), QM.Strings.QuestJobs},
		{4, "GUI_NewField",		QM.Windows.QuestEditor.name,GetString("questLevel"),	"eQuestLevel",	 GetString("details")},
		{3, "GUI_NewButton",	QM.Windows.QuestEditor.name,GetString("questDelete"),	"QM.DeleteQuest"},
		{3, "GUI_NewButton",	QM.Windows.QuestEditor.name,GetString("questSave"), 	"QM.ModifyQuest"},
		{3, "GUI_NewButton",	QM.Windows.QuestEditor.name,GetString("questEditSteps"), 	"QMToggleStepManager"},
		{3, "GUI_NewButton",	QM.Windows.QuestEditor.name,GetString("questEditPreReqs"),	"QMTogglePreReqEditor"},
	},
	PreReqEditor = {
		{5, "GUI_NewComboBox",	QM.Windows.PreReqEditor.name,GetString("prereqJob"),	"qPreReqJob",	GetString("newQuestPreReq"), QM.Strings.PreReqJobs},		
		{4, "GUI_NewField",		QM.Windows.PreReqEditor.name,GetString("prereqStep"),"qPreReqStep", 	GetString("newQuestPreReq")},
		{4, "GUI_NewField",		QM.Windows.PreReqEditor.name,GetString("prereqID"),	"qPreReqID",  	GetString("newQuestPreReq")},
		{3, "GUI_NewButton", 	QM.Windows.PreReqEditor.name,GetString("prereqClear"),	"QM.ClearPreReqs"},
		{3, "GUI_NewButton",	QM.Windows.PreReqEditor.name,GetString("questAddPreReq"),			"QM.AddPreReq"},
	},
	StepManager = {
		{4, "GUI_NewField",		QM.Windows.StepManager.name,GetString("stepCurrent"),	"qStepNum",		GetString("newQuestStep")},
		{5, "GUI_NewComboBox",	QM.Windows.StepManager.name,GetString("stepTask"),		"qStepTask",	GetString("newQuestStep"),	QM.Strings.QuestTasks},
		{3, "GUI_NewButton", 	QM.Windows.StepManager.name,GetString("stepClear"), 	"QM.ClearSteps"},
		{3, "GUI_NewButton",	QM.Windows.StepManager.name,GetString("questEditTurnovers"),	"QMToggleTurnInEditor"},
	},
	StepEditor = {
		{4, "GUI_NewField",		QM.Windows.StepEditor.name,GetString("stepCurrent"),	"eStepNum",		GetString("editQuestStep")},
		{5, "GUI_NewComboBox",	QM.Windows.StepEditor.name,GetString("stepTask"),		"eStepTask",	GetString("editQuestStep"),	QM.Strings.QuestTasks},
		{3, "GUI_NewButton", 	QM.Windows.StepEditor.name,GetString("questStepSave"), 	"QM.SaveStep"},
		{3, "GUI_NewButton", 	QM.Windows.StepEditor.name,GetString("questStepDelete"), 	"QM.RemoveStep"},
		{3, "GUI_NewButton", 	QM.Windows.StepEditor.name,GetString("questDown"), 	"QM.StepPriorityDown"},
		{3, "GUI_NewButton", 	QM.Windows.StepEditor.name,GetString("questUp"), 		"QM.StepPriorityUp"},
	},
	EncounterEditor = {
		{4, "GUI_NewField",		QM.Windows.EncounterEditor.name,GetString("stepCurrent"),		"eEncounterNum",	"Edit Encounter Step"},
		{5, "GUI_NewComboBox",	QM.Windows.EncounterEditor.name,GetString("stepTask"),		"eEncounterTask",		"Edit Encounter Step",	QM.Strings.DutyTasks},
		{3, "GUI_NewButton", 	QM.Windows.EncounterEditor.name,GetString("questStepSave"), 	"QM.SaveEncounter"},
		{3, "GUI_NewButton", 	QM.Windows.EncounterEditor.name,GetString("questStepDelete"), 	"QM.RemoveEncounter"},
		{3, "GUI_NewButton", 	QM.Windows.EncounterEditor.name,GetString("questDown"), 	"QM.EncounterPriorityDown"},
		{3, "GUI_NewButton", 	QM.Windows.EncounterEditor.name,GetString("questUp"), 		"QM.EncounterPriorityUp"},
	},
	ItemEditor = {
		{5, "GUI_NewComboBox",	QM.Windows.ItemEditor.name,GetString("questJob"),			"qTaskItemJobReq",	GetString("newItem"), QM.Strings.QuestJobs},
		{4, "GUI_NewField",		QM.Windows.ItemEditor.name,GetString("stepItemID"),		"qTaskItemID",		GetString("newItem")},
		{3, "GUI_NewButton", 	QM.Windows.ItemEditor.name,GetString("questClearItems"), 	"QM.ClearStepItems"},
		{3, "GUI_NewButton",	QM.Windows.ItemEditor.name,GetString("questAddItem"), 	"QM.AddStepItem"},
	},
	TurnInEditor = {
		{4, "GUI_NewField",	QM.Windows.TurnInEditor.name,GetString("turnoverStep"),"qTurnoverStep",GetString("newQuestTurnover")},
		{4, "GUI_NewField",	QM.Windows.TurnInEditor.name,GetString("turnoverID"),	"qTurnoverID",	GetString("newQuestTurnover")},
		{4, "GUI_NewNumeric",	QM.Windows.TurnInEditor.name,GetString("turnoverSlot"),"qTurnoverSlot",GetString("newQuestTurnover")},
		{3, "GUI_NewButton", 	QM.Windows.TurnInEditor.name,GetString("turnoverClear"), "QM.ClearTurnovers"},
		{3, "GUI_NewButton",	QM.Windows.TurnInEditor.name,GetString("questAddTurnover"), "QM.AddTurnover"},
	},
	QuestTasks = {
		["start"] = {
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepCurrent"),	"qStepNum",	GetString("newQuestStep")},
			{5, "GUI_NewComboBox",QM.Windows.StepManager.name,GetString("stepTask"),	"qStepTask",GetString("newQuestStep"),	QM.Strings.QuestTasks},
			{4, "GUI_NewField",	QM.Windows.StepManager.name,"Index","qTaskIndex",GetString("newQuestStep")},
		...
		["accept"] = {
			...
			{5, "GUI_NewComboBox",QM.Windows.StepManager.name,GetString("stepTask"),	"qStepTask",GetString("newQuestStep"),	QM.Strings.QuestTasks},
			{4, "GUI_NewField",	QM.Windows.StepManager.name,"Index","qTaskIndex",GetString("newQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepQuestID"),	"qTaskQuestID",	GetString("newQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepMap"),"qTaskMap",	GetString("newQuestStep")},
			{5, "GUI_NewComboBox",QM.Windows.StepManager.name,GetString("stepMesh"),"qTaskMesh",GetString("newQuestStep"), QM.Strings.Meshes },
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepTarget"),"qTaskNPC",GetString("newQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepDelay"),"qTaskDelay",GetString("newQuestStep")},
		...
		["kill"] = {
			...
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepMap"),		"qTaskMap",GetString("newQuestStep")},
			{5, "GUI_NewComboBox",QM.Windows.StepManager.name,GetString("stepMesh"),	"qTaskMesh",GetString("newQuestStep"), QM.Strings.Meshes },
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepTarget"),	"qTaskKillTarget",GetString("newQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepKillCount"),  "qTaskKillCount",GetString("newQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepDelay"),"qTaskDelay",GetString("newQuestStep")},
			{4, "GUI_NewButton",	QM.Windows.StepManager.name,GetString("questPullValues"), "QM.LoadAddCurrentValues",GetString("newQuestStep")},
			{4, "GUI_NewButton",	QM.Windows.StepManager.name,GetString("questAddStep"), "QM.AddStep",GetString("newQuestStep")},
		},
		["dutykill"] = {
			...
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepMap"),		"qTaskMap",GetString("newQuestStep")},
			{5, "GUI_NewComboBox",QM.Windows.StepManager.name,GetString("stepMesh"),	"qTaskMesh",GetString("newQuestStep"), QM.Strings.Meshes },
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepTarget"),	"qTaskKillPriorities",GetString("newQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepDelay"),"qTaskDelay",GetString("newQuestStep")},
			{4, "GUI_NewButton",	QM.Windows.StepManager.name,GetString("questPullValues"), "QM.LoadAddCurrentValues",GetString("newQuestStep")},
			{4, "GUI_NewButton",	QM.Windows.StepManager.name,GetString("questAddStep"), "QM.AddStep",GetString("newQuestStep")},
		},
		...
		["textcommand"] = {
			...
			{5, "GUI_NewComboBox",QM.Windows.StepManager.name,GetString("stepMesh"),"qTaskMesh",GetString("newQuestStep"), QM.Strings.Meshes },
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepTarget"),"qTaskNPC",GetString("newQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepCommandString"),"qTaskCommandString",GetString("newQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepDelay"),"qTaskDelay",GetString("newQuestStep")},
			{4, "GUI_NewButton",	QM.Windows.StepManager.name,GetString("questPullValues"), "QM.LoadAddCurrentValues",GetString("newQuestStep")},
			{4, "GUI_NewButton",	QM.Windows.StepManager.name,GetString("questAddStep"), "QM.AddStep",GetString("newQuestStep")},
		},
		["useitem"] = {
			...
			{5, "GUI_NewComboBox",QM.Windows.StepManager.name,GetString("stepMesh"),"qTaskMesh",GetString("newQuestStep"), QM.Strings.Meshes },
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepTarget"),"qTaskNPC",GetString("newQuestStep")},
			{4, "GUI_NewCheckbox",QM.Windows.StepManager.name,"AOE Item","qTaskUsePos",GetString("newQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepManager.name,"X","qTaskUsePosX",GetString("newQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepManager.name,"Y","qTaskUsePosY",GetString("newQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepManager.name,"Z","qTaskUsePosZ",GetString("newQuestStep")},
			{4, "GUI_NewNumeric",QM.Windows.StepManager.name,GetString("stepItemSelector"),"qTaskItemSelector",GetString("newQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepItemID"),"qTaskItemID", GetString("newQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepDelay"),"qTaskDelay",GetString("newQuestStep")},
			{4, "GUI_NewButton",	QM.Windows.StepManager.name,GetString("questPullValues"), "QM.LoadAddCurrentValues",GetString("newQuestStep")},
			{4, "GUI_NewButton",	QM.Windows.StepManager.name,GetString("questAddStep"), "QM.AddStep",GetString("newQuestStep")},
		},
		["useaction"] = {
			...
			{5, "GUI_NewComboBox",QM.Windows.StepManager.name,GetString("stepMesh"),"qTaskMesh",GetString("newQuestStep"), QM.Strings.Meshes },
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepTarget"),"qTaskNPC",GetString("newQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepAction"),"qTaskAction", GetString("newQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepDelay"),"qTaskDelay",GetString("newQuestStep")},
			{4, "GUI_NewButton",	QM.Windows.StepManager.name,GetString("questPullValues"), "QM.LoadAddCurrentValues",GetString("newQuestStep")},
			{4, "GUI_NewButton",	QM.Windows.StepManager.name,GetString("questAddStep"), "QM.AddStep",GetString("newQuestStep")},
		},
		["vendor"] = {
			...
			{5, "GUI_NewComboBox",QM.Windows.StepManager.name,GetString("stepMesh"),"qTaskMesh",GetString("newQuestStep"), QM.Strings.Meshes },
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepTarget"),"qTaskNPC",GetString("newQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("convoIndex"),"qTaskConvoIndex", GetString("newQuestStep")},
			{4, "GUI_NewNumeric",	QM.Windows.StepManager.name,GetString("stepItemAmount"),"qTaskItemAmount",	GetString("newQuestStep")},			
			{4, "GUI_NewField",	QM.Windows.StepManager.name,GetString("stepDelay"),"qTaskDelay",GetString("newQuestStep")},
			{4, "GUI_NewButton",	QM.Windows.StepManager.name,GetString("questPullValues"), "QM.LoadAddCurrentValues",GetString("newQuestStep")},
			{4, "GUI_NewButton",	QM.Windows.StepManager.name,GetString("questAddStep"), "QM.AddStep",GetString("newQuestStep")},
		},
	...
	QuestTasksEdit = {
		...
		["kill"] = {
			...
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,GetString("stepMap"),		"eTaskMap",GetString("editQuestStep")},
			{5, "GUI_NewComboBox",	QM.Windows.StepEditor.name,GetString("stepMesh"),	"eTaskMesh",GetString("editQuestStep"), QM.Strings.Meshes },
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,GetString("stepTarget"),	"eTaskKillTarget",GetString("editQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,GetString("stepKillCount"),  "eTaskKillCount",GetString("editQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,GetString("stepDelay"),"eTaskDelay",GetString("editQuestStep")},
			{4, "GUI_NewButton",	QM.Windows.StepEditor.name,GetString("questPullValues"), "QM.LoadEditCurrentValues",GetString("editQuestStep")},
		},
		["dutykill"] = {
			{5, "GUI_NewComboBox",QM.Windows.StepEditor.name,GetString("stepTask"),	"eStepTask",GetString("editQuestStep"),	QM.Strings.QuestTasks},
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,GetString("stepMap"),		"eTaskMap",GetString("editQuestStep")},
			{5, "GUI_NewComboBox",	QM.Windows.StepEditor.name,GetString("stepMesh"),	"eTaskMesh",GetString("editQuestStep"), QM.Strings.Meshes },
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,GetString("stepTarget"),	"eTaskKillPriorities",GetString("editQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,GetString("stepDelay"),"eTaskDelay",GetString("editQuestStep")},
			{4, "GUI_NewButton",	QM.Windows.StepEditor.name,GetString("questPullValues"), "QM.LoadEditCurrentValues",GetString("editQuestStep")},
		},
		["interact"] = {
		...
		["textcommand"] = {
			...
			{5, "GUI_NewComboBox",QM.Windows.StepEditor.name,GetString("stepMesh"),"eTaskMesh",GetString("editQuestStep"), QM.Strings.Meshes },
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,GetString("stepTarget"),"eTaskNPC",GetString("editQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,GetString("stepCommandString"),"eTaskCommandString",GetString("editQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,GetString("stepDelay"),"eTaskDelay",GetString("editQuestStep")},
			{4, "GUI_NewButton",	QM.Windows.StepEditor.name,GetString("questPullValues"), "QM.LoadEditCurrentValues",GetString("editQuestStep")},
		},
		["useitem"] = {
			...
			{5, "GUI_NewComboBox",QM.Windows.StepEditor.name,GetString("stepMesh"),"eTaskMesh",GetString("editQuestStep"), QM.Strings.Meshes },
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,GetString("stepTarget"),"eTaskNPC",GetString("editQuestStep")},
			{4, "GUI_NewCheckbox",QM.Windows.StepEditor.name,"AOE Item","eTaskUsePos",GetString("editQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,"X","eTaskUsePosX",GetString("editQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,"Y","eTaskUsePosY",GetString("editQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,"Z","eTaskUsePosZ",GetString("editQuestStep")},
			{4, "GUI_NewNumeric",	QM.Windows.StepEditor.name,GetString("stepItemSelector"),"eTaskItemSelector",GetString("editQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,GetString("stepItemID"),"eTaskItemID", GetString("editQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,GetString("stepDelay"),"eTaskDelay",GetString("editQuestStep")},
			{4, "GUI_NewButton",	QM.Windows.StepEditor.name,GetString("questPullValues"), "QM.LoadEditCurrentValues",GetString("editQuestStep")},
		},
		["useaction"] = {
			...
			{5, "GUI_NewComboBox",QM.Windows.StepEditor.name,GetString("stepMesh"),"eTaskMesh",GetString("editQuestStep"), QM.Strings.Meshes },
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,GetString("stepTarget"),"eTaskNPC",GetString("editQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,GetString("stepAction"),"eTaskAction", GetString("editQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,GetString("stepDelay"),"eTaskDelay",GetString("editQuestStep")},
			{4, "GUI_NewButton",	QM.Windows.StepEditor.name,GetString("questPullValues"), "QM.LoadEditCurrentValues",GetString("editQuestStep")},
		},
		["vendor"] = {
			...
			{5, "GUI_NewComboBox",QM.Windows.StepEditor.name,GetString("stepMesh"),"eTaskMesh",GetString("editQuestStep"), QM.Strings.Meshes },
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,GetString("stepTarget"),"eTaskNPC",GetString("editQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,GetString("convoIndex"),"eTaskConvoIndex", GetString("editQuestStep")},
			{4, "GUI_NewNumeric",	QM.Windows.StepEditor.name,GetString("stepItemAmount"),"eTaskItemAmount",	GetString("editQuestStep")},
			{4, "GUI_NewField",	QM.Windows.StepEditor.name,GetString("stepDelay"),"eTaskDelay",GetString("editQuestStep")},
			{4, "GUI_NewButton",	QM.Windows.StepEditor.name,GetString("questItemEditor"), "QMToggleItemEditor",GetString("editQuestStep")},
			{4, "GUI_NewButton",	QM.Windows.StepEditor.name,GetString("questPullValues"), "QM.LoadEditCurrentValues",GetString("editQuestStep")},
		},
		["finish"] = {
			{5, "GUI_NewComboBox",QM.Windows.StepEditor.name,GetString("stepTask"),	"eStepTask",GetString("editQuestStep"),	QM.Strings.QuestTasks},
...
function QM.RefreshQuests()
	GUI_DeleteGroup(QM.Windows.Main.name,GetString("quests"))
...
function QM.RefreshEncounters()		
	GUI_DeleteGroup(QM.Windows.Main.name,GetString("dutyEncounters"))
	if (TableSize(QM.Encounters) > 0) then
		for k,v in spairs(QM.Encounters) do
			GUI_NewButton(QM.Windows.Main.name, tostring(k).."("..v.taskFunction..")", "QMEncounterEdit"..tostring(k), GetString("dutyEncounters"))
		end
		GUI_UnFoldGroup(QM.Windows.Main.name,GetString("dutyEncounters"))
	end
...
function QM.LoadTaskFields()	
	...
	GUI_DeleteGroup(QM.Windows.StepManager.name,GetString("newQuestStep"))
	...
	GUI_UnFoldGroup(QM.Windows.StepManager.name,GetString("newQuestStep"))
...
function QM.LoadTaskEditFields(steptype, preserve)
	...
	GUI_DeleteGroup(QM.Windows.StepEditor.name,GetString("editQuestStep"))
	...
	GUI_UnFoldGroup(QM.Windows.StepEditor.name,GetString("editQuestStep"))
	QM.LoadVariables()
...
function QM.LoadWindows()	
	...
	for k,v in pairs(windows) do
		if (TableSize(QM.Builds[k]) > 0) then
			local wname = v.name
			if (wname == GetString("profileManager")) then
