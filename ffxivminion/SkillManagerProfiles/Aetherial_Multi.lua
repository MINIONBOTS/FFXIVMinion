...
local obj1 = {
	...
	["skills"] = {
		...
		[5] = {
			...
			["gpnbuff"] = "805";
			["gsecspassed"] = 0;
			["hasitem"] = "Clary Sage,Black Soil,Furymint,Peat Moss,Highland Oregano,Granular Clay,Grade 4 Carbonized Matter,Grade 5 Carbonized Matter,Adamantite Ore,Chysahl Greens";
			["id"] = 224;
			["isunspoiled"] = "0";
			["itemchancemax"] = 0;
			["itemhqchancemin"] = 0;
